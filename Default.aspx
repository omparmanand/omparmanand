          ...
          <div class="row">
             <div class="col-md-6 col-lg-7 text-center">
                ...
                <p class="text-justify" >
                 ...
                 <a href="babaji.aspx" class="btn btn-default">अधिक माहितीसाठी क्लीक करा </a>
             </div>              
       <!-- /col-md-7-->
             <!-- Parallax object -->
                           ...
                           <div class="icon">
                              ...
                              <div class="info">
                                ...
                                अनादी काळापासून भव–भयाचा नाश करणारी आदि शक्ति, आदि माया म्हणून भांगसी मातेचे हे स्थान अतिशय जागृत आणि पवित्र मानले जाते.<br/><br/></p>                    
                                 <!-- Button-->
                                 <a href="mandir.aspx" class="btn">अधिक माहिती</a>
                              </div>
                           </div>
                        </div>
                        <!-- /box_icon -->
                        ...
                        <div class="box_icon">
                           <div class="icon">
                              ...
                              <div class="info">
                                 ...
                                 <!-- Button-->
                                 <a href="goshala.aspx" class="btn">अधिक माहिती</a>
                              </div>
                           </div>
                        </div>
                        <!-- /box_icon -->
                        ...
                        <div class="box_icon">
                           <div class="icon">
                              ...
                              <div class="info">
                                 ...
                                 <!-- Button-->
                                 <a href="ashram.aspx" class="btn">अधिक माहिती</a>
                              </div>
                           </div>
                        </div>
                        <!-- /box_icon -->
                        ...
                        <div class="box_icon">
                           <div class="icon">
                              ...
                              <div class="info">
                                 ...
                                 <!-- Button-->
                                 <a class="btn" href="gurukul.aspx">अधिक माहिती</a>
                              </div>
                           </div>
                        </div>
                        <!-- /box_icon -->
